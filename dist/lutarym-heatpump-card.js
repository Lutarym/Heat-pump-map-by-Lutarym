...
class LutarymHeatpumpCard extends HTMLElement {
  ...
  _svg() {
    ...
    <svg viewBox="0 0 ${L.W} ${L.H}" class="lhc-svg" role="img"
      ...
      <!-- Sammelleitungen -->
      <path class="pipe-shell" d="M1602 ${R} H 280"/>
      <path class="pipe" id="pipe-return" d="M1602 ${R} H 280"/>
      ...
      <path class="flowdots rev" id="dots-rl-a" d="M630 ${R} H 280"/>
      <path class="flowdots rev" id="dots-rl-b" d="M1602 ${R} H 280"/>
