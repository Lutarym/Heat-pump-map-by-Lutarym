  ...
  _svg() {
    ...
    <svg viewBox="0 0 ${L.W} ${L.H}" class="lhc-svg" role="img"
      ...
      <g id="zirkulation-group" opacity="0">
        <path class="pipe-shell" fill="none" d="M1440 380 H 1230 V 600 H 1440"/>
        <path class="pipe" id="pipe-zirk" fill="none" d="M1440 380 H 1230 V 600 H 1440"/>
        <path class="flowdots" id="dots-zirk" fill="none" d="M1440 380 H 1230 V 600 H 1440"/>
